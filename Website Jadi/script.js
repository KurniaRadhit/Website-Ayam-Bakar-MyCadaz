document.addEventListener('DOMContentLoaded', function () {
    ...
    if (galleryContainer) {
        ...
        function createFoodItemElement(item) {
            ...
            foodItem.className = 'food-item-menu';
            ...
            foodImage.className = 'food-image-menu';
            foodImage.src = item.image;
            foodImage.alt = item.name;
            foodImage.loading = 'lazy';

            overlay.className = 'overlay-menu';
            foodInfo.className = 'food-info-menu';
            foodName.className = 'food-name-menu';
            foodPrice.className = 'food-price-menu';
            learnMoreBtn.className = 'learn-more-btn-menu';

            // Set content
            foodName.textContent = item.name;
            foodPrice.textContent = `Rp. ${item.price.toFixed(3)}`;
        ...
        function showFoodDetails(item) {
            ...
            modalPrice.textContent = `Rp. ${item.price.toFixed(3)}`;
